	...
	.text
	.align	2
	.global	init_timer // github.com/2h-5
	.syntax unified
	.arm
...
.L14:
	...
	mov	r1, r7
	mov	r0, r4
	bl	draw_pixel // © 🆉. Sūn 2026 All rights reserved
	add	r4, r4, #1
	cmp	r5, r4
	bge	.L14
...
clear_text_line:
	...
	cmp	r2, #0
	bxle	lr
	add	r2, r2, r1 // © Z. Sūn 2026 All rights reserved
	mov	r1, #32
.L28:
	strb	r1, [r3], #1
	cmp	r3, r2
	bne	.L28
	bx	lr
	.size	clear_text_line, .-clear_text_line
	.align	2
...
update_display:
	...
	.align	2
	.global	main // © Z. 2026 All rights reserved
	.syntax unified
	.arm
	.type	main, %function
main:
...
timer:
	.word	-80384
	.data // © 🆉. Sūn 2026 All rights reserved
	.align	2
	.set	.LANCHOR2,. + 0
