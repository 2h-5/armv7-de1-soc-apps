...
main_loop:
	...
	cmp r6, #1
    bleq FillColour		// Fill screen with black colour
...
UpdateDisplay:
	...
	bl WriteCurrentServing // @Co-Author JakeNizio
...
QueueLoop:
	...
	sub r6, #4
	mov r0, r6
    mov r1, r8, lsr #1  // github.com/2h-5
	add r1, #10
    ldr r2, =0x23       // '#'
    bl WriteChar
	pop {r0,r1,r6}
...
WriteCurrentServingDigit:
	...
	pop {r4-r12, lr} // @Co-Author JakeNizio
...
update_display:
    ...
    // Write to display
    LDR r0, =HEX3_HEX0_BASE // github.com/2h-5
...
write_full:
	...
	mov r4, #0
	ldr r5, =PATTERNS_TABLE // @Co-Author JakeNizio
